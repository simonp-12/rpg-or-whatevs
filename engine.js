            ...
            (function preloadImages() {
                ...
                const imageObjectList = [{imageName:'crop[1]',backupColor:'red'}, {imageName:'crop[2]',backupColor:'red'}, {imageName:'crop[3]',backupColor:'red'}, {imageName:'crop[4]',backupColor:'red'}, {imageName:'crop[5]',backupColor:'red'}, {imageName:'crop[6]',backupColor:'red'}, {imageName:'crop[7]',backupColor:'red'}, {imageName:'crop[8]',backupColor:'red'}, {imageName:'crop[9]',backupColor:'red'}, {imageName:'crop[10]',backupColor:'red'}, {imageName:'crop[11]',backupColor:'red'}, {imageName:'crop[12]',backupColor:'red'}, {imageName:'cat[1]',backupColor:'black'}, {imageName:'cat[2]',backupColor:'black'}, {imageName:'cat[3]',backupColor:'black'}, {imageName:'cat[4]',backupColor:'black'}, {imageName:'cat[5]',backupColor:'black'}, {imageName:'cat[6]',backupColor:'black'}, {imageName:'cat[7]',backupColor:'black'}, {imageName:'cat[8]',backupColor:'black'}, {imageName:'cat[9]',backupColor:'black'}, {imageName:'cat[10]',backupColor:'black'}, {imageName:'cat[11]',backupColor:'black'}, {imageName:'cat[12]',backupColor:'black'}, {imageName:'grass',backupColor:'green'}];
